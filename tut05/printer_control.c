...
{
    // TODO
    // Using NO_INK as our mask, extract just the NO_INK bit
    if (printerControl & NO_INK) {
        printf("Printer has no ink\n");
    } else {
...
{
    // Set NO_INK to 0 to say we have ink again

    printerControl = (~NO_INK) & printerControl;
...
{
    printerControl = printerControl | SELECT_SCAN | COLOUR;
    // TODO
}
